...
const StepIndicator = () => {
  ...
  return (
    <div className="relative flex items-center justify-between w-full max-w-md">
      ...
      <div className="absolute top-1/2 left-0 w-full h-0.5 bg-pink-600 -translate-y-1/2" style={{ width: '50%' }}></div>

      {/* Titik Langkah */}
      {steps.map((step, index) => (
        <div key={step} className="relative z-10 flex flex-col items-center">
          <div className={`w-4 h-4 rounded-full ${index < 2 ? 'bg-pink-600' : 'bg-gray-200'}`}></div>
        ...
        <div className="flex flex-col lg:flex-row items-center justify-center gap-12">
          ...
          <div className="lg:w-1/2 lg:text-left">
            ...
            <Link href="/simulasi-wawancara/cek-perangkat">
              <button className="bg-pink-600 text-white font-semibold py-3 px-6 rounded-lg hover:bg-pink-700 transition-colors">
